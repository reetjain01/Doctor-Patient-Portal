...
public class Appointment {
	...
	public Appointment(int id, int userId, String fullName, String gender, String age, String appointmentDate,
			String email, String phone, String diseases, String slot, int doctorId, String address, String status) {
		super();
		this.id = id;
		this.userId = userId;
	...
	public Appointment(int userId, String fullName, String gender, String age, String appointmentDate, String email,
			String phone, String diseases, int doctorId,String slot, String address, String status) {
		super();
		this.userId = userId;
		this.fullName = fullName;
		this.gender = gender;
