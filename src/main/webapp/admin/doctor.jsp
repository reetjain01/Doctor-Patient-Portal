...
<%@page import="com.example.project_4.entity.Specialist"%>
<%@page import="java.util.List"%>
<%@page import="com.example.project_4.db.DBConnection"%>
<%@page import="com.example.project_4.dao.SpecialistDAO"%>
						...
						<form action="../addDoctor" method="post">
							<div class="mb-3">
								<label class="form-label">Full Name</label> <input
									name="fullNameDoc" type="text" placeholder="Enter full name"
									class="form-control">
