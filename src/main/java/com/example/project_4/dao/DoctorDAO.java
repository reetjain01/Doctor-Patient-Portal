...
public class DoctorDAO {
	...
	public boolean registerDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "insert into doctor(fullNameDoc,dateOfBirth,qualification,specialist,email,phone,password) values(?,?,?,?,?,?,?)";

			PreparedStatement pstmt = this.conn.prepareStatement(sql);
			pstmt.setString(1, doctor.getFullNameDoc());
	...
	public List<Doctor> getAllDoctor() {
		...
		try {
			...
			while (resultSet.next()) {
				...
				doctor.setFullNameDoc(resultSet.getString("fullNameDoc"));
	...
	public boolean updateDoctor(Doctor doctor) {
		...
		try {
			...
			String sql = "update doctor set fullNameDoc=?,dateOfBirth=?,qualification=?,specialist=?,email=?,phone=?,password=? where id=?";
	...
	public Doctor loginDoctor(String email, String password) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				doctor.setFullNameDoc(resultSet.getString(2));
	...
	public boolean editDoctorProfile(Doctor doctor) {
		...
		try {
			...
			String sql = "update doctor set fullNameDoc=?,dateOfBirth=?,qualification=?,specialist=?,email=?,phone=? where id=?";
