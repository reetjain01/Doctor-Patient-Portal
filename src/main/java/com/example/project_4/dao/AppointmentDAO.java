...
public class AppointmentDAO {
	...
	public boolean addAppointment(Appointment appointment) {
		...
		try {
			...
			String sql = "insert into appointment(userId, fullName, gender, age, appointmentDate, email, phone, diseases, doctorId,slot, address, status) values(?,?,?,?,?,?,?,?,?,?,?,?)";
			...
			pstmt.setString(10, appointment.getSlot());
	...
	public List<Appointment> getAllAppointmentByLoginUser(int userId) {
		...
		try {
			...
			while (resultSet.next()) {
				...
				appointment.setSlot(resultSet.getString(11));
				appointment.setAddress(resultSet.getString(12));
				appointment.setStatus(resultSet.getString(13));
